...
static error_code_t on_document_begin(generator_t *super, const YYLTYPE *yylloc, const char *file_name)
{
	...
	// generator_printline(super, 0, "#include \"tdr_abstract_writer.h\"");
	generator_printline(super, 0, "#include \"tdr_error_code.h\"");
	...
	generator_printline(super, 0, "");
	generator_printline(super, 0, "typedef struct tdr_abstract_writer_s tdr_abstract_writer_t;\n");
	generator_printline(super, 0, "");
	return E_TD_NOERROR;
}
